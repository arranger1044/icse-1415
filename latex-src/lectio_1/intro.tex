...
% \begin{frame}
%   \frametitle{Database Triggers}
%   In \emph{active databases}, triggers are rules that fire when a certain
%   \textsf{E}vent occurs and a \textsf{C}ondition is met, then an
%   \textsf{A}ction is executed (\textsf{ECA}).\par\bigskip
